...
int* MuscleModel::spike_train(double T, int firing_rate){
	int max_n;
	int i;
...
//Working
double* MuscleModel::gen_h_diff_eq(int firing_rate){
	int *spikes;
	int i;
	int spike_i1;
	int spike_i2;
...
double* MuscleModel::plotForce(int firing_rate, double* x){
	int i;
	double T_i1;
	double t;
	double A;
...
//Working
double* MuscleModel::gen_waveform(double L1, double L2, double T){
...
double MuscleModel::stepping_model(double delta_t, int spike)
{
	double A;
	double dT;
